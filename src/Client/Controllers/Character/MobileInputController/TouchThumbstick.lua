...
function TouchThumbstick.new()
    ...
    self.MoveVectorChanged = Signal.new()

	
	return self
end
function TouchThumbstick:SetMoveVector( vector: Vector3? ): ()
    self.MoveVector = vector or ZERO_VECTOR3
...
function TouchThumbstick:Enable(enable: boolean?, uiParentFrame)
	...
	self.moveVector = ZERO_VECTOR3
    self:SetMoveVector( ZERO_VECTOR3 )
...
function TouchThumbstick:Create(parentFrame)
	...
	local function DoMove(direction: Vector2)
        ...
        self:SetMoveVector( currentMoveVector )
	end
	...
	self.thumbstickFrame.InputBegan:Connect(function(inputObject: InputObject)
		--A touch that starts else where on the screen will be sent to a frame's InputBegan event
