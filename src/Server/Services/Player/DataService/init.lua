...
--[[
    ...
    FUNCTION    DataService:SetPlayerData( player: Player, dataName: string, value: any?, replicateToClient: boolean? = true ) -> ()
    FUNCTION    DataService:IncrementPlayerData( player: Player, dataName: string, incrementAmount: number, replicateToClient: boolean? = true ) -> ()
]]

---------------------------------------------------------------------

-- Constants
local STORE_NAME = ( game:GetService("RunService"):IsStudio() and ("Data_" .. os.time()) ) or "PlayerData"
...
function DataService:OnPlayerDataLoaded( player: Player, profile: {} ): ()
end
    ...
    local function OnPlayerAdded( player: Player ): nil
        ...
        if ( profile ) then
            ...
            if ( player:IsDescendantOf(game) ) then
                ...
                self:OnPlayerDataLoaded( player, profile )
            else
                profile:Release()
            end
        else
